...
To:
#+DOWNLOADED: screenshot @ 2026-08-17 13:20:00
[[file:images/why/2026-08-17_fog-over-fen-members.png]]
*** But... [x] does this
...
*** Typography
- Body: [[https://fonts.google.com/specimen/Source+Serif+4][Source Serif 4]]
- Headings: [[https://fonts.google.com/specimen/Fraunces][Fraunces]]
- UI: [[https://fonts.google.com/specimen/Source+Sans+3][Source Sans 3]]
- Code: [[https://sourcefoundry.org/hack/][Hack]]
...
#+DOWNLOADED: screenshot @ 2026-08-17 13:20:00
[[file:images/why/2026-08-17_fog-over-fen-index-dark.png]]
...
Live: [[https://doxyyoda.rgoswami.me/][doxyyoda.rgoswami.me]]

#+DOWNLOADED: screenshot @ 2026-08-17 13:20:00
[[file:images/why/2026-08-17_fog-over-fen-index-light.png]]
...
** Users
Sites that still ship the doxyYoda HTML theme (most published trees are still
on an older tarball; the current release is the demo):

- [[https://doxyyoda.rgoswami.me/][doxyYoda demo]] (this theme, =v0.2.2=)
- [[https://eondocs.org/api-cpp/][eOn C++ API]] (sibling of the Sphinx book, =v0.2.2=)
- [[https://gproptim.rgoswami.me/api-cpp/][gpr_optim C++ API]] (sibling of the Sphinx book, =v0.2.2=)
...
d-SEAMS developer docs are Sphinx / Shibuya / doxyrest now
([[https://docs.dseams.info][docs.dseams.info]]), not this theme.
